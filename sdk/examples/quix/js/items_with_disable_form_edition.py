...
class QuixJSItemsDisableFormEdition:

    @staticmethod
    def send_quix_js_items_disable_form_edition():
        try:
            ...
            quix_item_pay_sol_extended_data.set_disable_form_edition(True)
...
if __name__ == "__main__":
    QuixJSItemsDisableFormEdition.send_quix_js_items_disable_form_edition()
