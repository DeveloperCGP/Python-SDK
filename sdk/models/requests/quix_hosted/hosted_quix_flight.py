...
class HostedQuixFlight(QuixHostedRequest):
    __paySolExtendedData: QuixFlightPaySolExtendedData = None

    def __init__(self):
        super().__init__()

    def get_pay_sol_extended_data(self) -> QuixFlightPaySolExtendedData:
