...
class HostedQuixService(QuixHostedRequest):
    __paySolExtendedData: QuixServicePaySolExtendedData = None

    def __init__(self):
        super().__init__()

    def get_pay_sol_extended_data(self) -> QuixServicePaySolExtendedData:
