...
class QuixCartService:
    ...
    def get_items(self) -> List[QuixServiceCartItem]:
        return self.__items

    def set_items(self, items: List[QuixServiceCartItem]) -> None:
        self.__items = items
