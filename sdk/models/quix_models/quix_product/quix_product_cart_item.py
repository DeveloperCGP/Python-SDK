...
class QuixProductCartItem:
    __article: QuixArticleProduct = None
    __units: int = None
    ...
    def __init__(self):
        self.__units = 0
        self.__total_price_with_tax = 0.0
        self.__auto_shipping = True

    def get_article(self) -> QuixArticleProduct:
        return self.__article

    def set_article(self, article: QuixArticleProduct) -> None:
