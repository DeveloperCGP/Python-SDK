...
class QuixCartAccommodation:
    __currency: Currency = None
    __total_price_with_tax: Decimal = None
    __items: List[QuixAccommodationCartItem] = None
    ...
    def set_total_price_with_tax(self, total_price_with_tax) -> None:
        ...
        self.__total_price_with_tax = Decimal(GeneralUtils.round_amount(total_price_with_tax))

    def get_items(self) -> List[QuixAccommodationCartItem]:
        return self.__items

    def set_items(self, items: List[QuixAccommodationCartItem]) -> None:
        self.__items = items
