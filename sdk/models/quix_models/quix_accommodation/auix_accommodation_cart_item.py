...
class QuixAccommodationCartItem:
    __article: QuixArticleAccommodation = None
    __units: int = None
    ...
    def get_article(self) -> QuixArticleAccommodation:
        return self.__article

    def set_article(self, article: QuixArticleAccommodation) -> None:
