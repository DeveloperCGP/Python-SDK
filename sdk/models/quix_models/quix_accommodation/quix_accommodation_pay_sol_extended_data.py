...
@dataclass
class QuixAccommodationPaySolExtendedData:
    ...
    __cart: QuixCartAccommodation = None
    ...
    def get_cart(self) -> QuixCartAccommodation:
        return self.__cart

    def set_cart(self, cart: QuixCartAccommodation) -> None:
        self.__cart = cart
    ...
    def to_dict(self):
        dict_with_none = {
            "product": self.__product,
            "disable_form_edition": self.__disable_form_edition,
