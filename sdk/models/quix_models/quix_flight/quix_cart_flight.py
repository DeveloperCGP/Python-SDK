...
class QuixCartFlight:
    ...
    def get_items(self) -> List[QuixFlightCartItem]:
        return self.__items

    def set_items(self, items: List[QuixFlightCartItem]) -> None:
        self.__items = items
